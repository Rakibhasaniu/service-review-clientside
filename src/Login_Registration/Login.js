    ...
    const handelSubmit = (event) => {
        ...
        singInPage(email, password)
            ...
            .then(result => {
                ...
                fetch('https://door-server.vercel.app/jwt', {
                    method: 'POST',
                    headers: {
    ...
    const forGetPassword = () => {
        ...
        forGetPass(userEmail)
            .then(() => {
                ...
                alert("Send a massage you Email please Chack !")
            })
            .catch(error => {
                alert(" You Email dosn't Matching !")
            })
    }
            ...
            <div className='flex justify-center items-center pt-8 mx-5 mt-16'>
                <div className='flex flex-col max-w-md px-6 py-2 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
                    ...
                    >
                        ...
                        <p className='text-center text-red-400 text-sm pb-1'>{error}</p><p className='text-center text-green-500 text-xs pb-1'>{success}</p>
                    ...
                    <div className='space-y-1'>
                        <button onClick={forGetPassword} className='text-xs hover:underline text-gray-400'>
                            Forgot password?
                        </button>
                    </div>
